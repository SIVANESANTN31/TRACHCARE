...
if(isset($obj["username"], $obj["email"], $obj["phone_number"], $obj["password"], $obj["doctor_reg_no"], )) {
    ...
    if ($image_data !== null) {
        ...
        $insert_sql = "INSERT INTO doctorprofile (username, doctor_reg_no, email, phone_number, password, image_path) 
                   VALUES ('$username', '$doctor_reg_no', '$email', '$phone_number', '$password', '$image_file')";
    }
